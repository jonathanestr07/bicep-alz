...
@description('Name of the Key Vault containing the secret for the admin password')
...
resource getKeyVault 'Microsoft.KeyVault/vaults@2024-11-01' existing = {
  name: keyVaultName
}
...
module virtualMachine 'br/public:avm/res/compute/virtual-machine:0.18.0' = [
  for (vm, index) in virtualMachines: {
    ...
    params: {
      ...
      adminPassword: getKeyVault.getSecret(secretName)
