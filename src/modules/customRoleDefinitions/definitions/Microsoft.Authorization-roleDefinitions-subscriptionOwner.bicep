...
var role = {
  ...
  description: 'Responsible for definition and management of a Landing Zone, including associated resource that are deployed into it, has the same RBAC permissions as the Contributor role, except for notActions on key networking resources.'
}
