...
@description('A list of management group scopes that will be used for role assignment.')
...
module roleAssignment 'roleAssignmentManagementGroup.bicep' = [
  for managementGroupId in managementGroupIds: {
    name: 'rbac-assign-${uniqueString(managementGroupId, assigneeObjectId, roleDefinitionId)}'
    scope: managementGroup(managementGroupId)
    params: {
      roleAssignmentNameGuid: guid(managementGroupId, roleDefinitionId, assigneeObjectId)
